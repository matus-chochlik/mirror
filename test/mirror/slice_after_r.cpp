/**
 *  .file test/mirror/slice_after_r.cpp
...
#define BOOST_TEST_MODULE MIRROR_slice_after
...
BOOST_AUTO_TEST_SUITE(mirror_slice_after)

BOOST_AUTO_TEST_CASE(mirror_slice_after_range)
{
...
BOOST_AUTO_TEST_CASE(mirror_slice_after_string)
{
	using namespace mirror;
