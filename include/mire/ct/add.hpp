...
// Single-parameter add_ meta function specialization
template <class Integer>
struct add_<Integer>
 : integral_constant<decltype(Integer::value), Integer::value>
{ };

// Multi-parameter add_ meta function specialization
template <class Integer, class ... Integers>
struct add_<Integer, Integers...>
 : integral_constant<
	decltype(Integer::value + add_<Integers...>::value),
	Integer::value + add_<Integers...>::value
>{ };
...
struct add_ : public IntegralConstant
{ };
#endif
