...
// unary operations
// boolean
template <__metaobject_id _Mp, typename = std::enable_if_t<
...
template <__metaobject_id _Mp, class _Cp, typename = std::enable_if_t<
  __metaobject_is_meta_record_member(_Mp) &&
  __metaobject_is_meta_variable(_Mp)>>
...
template <__metaobject_id _Mp, typename ... _Ap, typename = std::enable_if_t<
  __metaobject_is_meta_function(_Mp) ||
...
template <size_t _I, __metaobject_id _Mp, typename = std::enable_if_t<
  __metaobject_is_meta_object_sequence(_Mp)>>
...
// reflection "operator"
#define mirror(...) ::mirror::metaobject<__reflexpr_id(__VA_ARGS__)>{}
