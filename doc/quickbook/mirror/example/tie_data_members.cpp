...
//[mirror_example_tie_data_members_1
...
#include <tuple>
//]
//[mirror_example_tie_data_members_2
namespace {
...
private:
	...
	static auto _do_tie(T& v, range<MDMs...>)
	{
		return std::tie(__dereference<MDMs>::apply(v)...);
	}
public:
	auto operator()(T& v) const
	{
		auto MDMs = __unpack<__get_data_members<__MIRRORED(T)>>{};
...
//]
//[mirror_example_tie_data_members_3
struct Point
{
	int x, y, z;
};
...
//]
//[mirror_example_tie_data_members_4
int main(void)
{
