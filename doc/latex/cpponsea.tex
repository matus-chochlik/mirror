...
const auto (*@\listinghlt{meta_int}@*) = (*@\listinghl{mirror}\footnote{
      the reflection expression}@*)(int);
...
int main() {
  (*@\listinghls{hello}@*) world;

  std::cout << (*@\listinghlt{get_name}@*)(mirror((*@\listinghls{hello}@*)))
            << ", "
            << (*@\listinghlt{get_name}@*)(mirror(world))
            << "!" << std::endl;
...
\begin{frame}
  ...
  \item Return one of these things:
    \begin{itemize}
      ...
      \item pointers or references\footnote{to values, data member, functions} (\inlinecode{get_pointer}),
...
\begin{frame}[fragile]
  ...
  \begin{columns}
    \begin{column}{.50\textwidth}
      \begin{lstlisting}[language=c++2x,basicstyle=\tiny\ttfamily]
struct foo {
  int (*@\listinghlt{plus}@*)(int x) { return x; }

  int (*@\listinghlt{plus}@*)(int x, int y) {
    return x + y;
  }
  int (*@\listinghlt{plus}@*)(int x, int y, int z) {
    return x + y + z;
  }
  int (*@\listinghls{minus}@*)(int x) {
    return -x;
  }
  int (*@\listinghls{minus}@*)(int x, int y) {
    return x - y;
  }
};
      \end{lstlisting}
...
public:
  static auto revision_id() noexcept -> (*@\listinghls{hash_t}@*) {
    return (*@\listinghl{fold}@*)(
      (*@\listinghl{filter}@*)(
        (*@\listinghlt{get_member_functions}@*)(mirror(Intf)),
...
\begin{frame}
  ...
  \begin{itemize}
    \item {\em This presentation} --
      \url{https://matus-chochlik.github.io/mirror/latex/cpponsea.pdf}
