...
\begin{frame}[fragile]
  ...
  \framesubtitle{names}
  \begin{lstlisting}[language=c++2x]
auto get_name(metaobject auto mo) -> string_view
...
"string"
  ...
  \vfill
  \begin{lstlisting}[language=c++2x]
auto get_full_name(metaobject auto mo) -> string;
  \end{lstlisting}
  \begin{verbatim}
...
auto get_constant(metaobject auto mo) -> const auto
...
\begin{frame}[fragile]
  ...
  \begin{lstlisting}[language=c++2x,basicstyle=\small\ttfamily]
auto is_object_sequence(metaobject auto mo) -> bool;
  \end{lstlisting}
  \vfill
  Is there anything in the sequence?
  \begin{lstlisting}[language=c++2x,basicstyle=\footnotesize\ttfamily]
auto is_empty(metaobject auto mo) -> bool
  requires(is_object_sequence(mo));
  \end{lstlisting}
  \vfill
  How many elements are there?
  \begin{lstlisting}[language=c++2x,basicstyle=\footnotesize\ttfamily]
auto get_size(metaobject auto mo) -> size_t
  requires(is_object_sequence(mo));
  \end{lstlisting}
  \vfill
  ...
  \begin{lstlisting}[language=c++2x,basicstyle=\footnotesize\ttfamily]
template <size_t I>
auto get_element(metaobject auto mo)
  requires(is_object_sequence(mo));
  \end{lstlisting}
  \vfill
  Concatenate
  \begin{lstlisting}[language=c++2x,basicstyle=\footnotesize\ttfamily]
auto concat(metaobject auto... mo)
  requires((... && is_object_sequence(mo)));
  \end{lstlisting}
\end{frame}
% ------------------------------------------------------------------------------
...
public:
  auto make_call(metaobject auto mo, auto&... args)
    requires((*@\listinghl{reflects_expression}@*)(mo)) {
    packet request;
