...
\begin{frame}
  ...
  \LARGE
  \begin{itemize}
    \item Reflection \smaller and the reverse of reflection
  ...
  \begin{itemize}
    \item Provides access to {\em metadata} describing the reflected
      ...
      \smaller
        ...
        \item name of a namespace, type, function, data member, etc.
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item \footnotesize\inlinecodebreak{auto reflects_\{object_sequence, named, alias, typed,
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \smaller
      \item \inlinecode{reflects_expression},
        \inlinecode{get_source_line}, \inlinecode{get_source_column},
...
\begin{frame}[fragile]
  ...
  \framesubtitle{names}
  \begin{lstlisting}[language=c++2x]
auto (*@\listinghlt{get_name}@*)(metaobject auto mo)
  -> string_view
...
// "basic_string"
  ...
  \vfill
  \begin{lstlisting}[language=c++2x]
auto (*@\listinghlt{get_display_name}@*)(metaobject auto mo)
  -> string_view
  requires(reflects_named(mo));
// "string"
  \end{lstlisting}
  \vfill
  \begin{lstlisting}[language=c++2x]
auto (*@\listinghlt{get_full_name}@*)(metaobject auto mo)
  -> string;
...
auto (*@\listinghlt{uses_class_key}@*)(metaobject auto mo) -> bool
  ...
  \vfill
  \begin{lstlisting}[language=c++2x,basicstyle=\footnotesize\ttfamily]
auto (*@\listinghlt{uses_default_copy_capture}@*)(metaobject auto mo)
  -> bool
  requires(reflects_lambda(mo));
  \end{lstlisting}
  \vfill
  \begin{lstlisting}[language=c++2x,basicstyle=\footnotesize\ttfamily]
auto (*@\listinghlt{is_explicitly_captured}@*)(metaobject auto mo)
  -> bool
...
auto (*@\listinghlt{has_lvalueref_qualifier}@*)(metaobject auto mo) -> bool
  ...
  \vfill
  \begin{lstlisting}[language=c++2x,basicstyle=\footnotesize\ttfamily]
auto (*@\listinghlt{is_implicitly_declared}@*)(metaobject auto mo)
  -> bool
...
auto (*@\listinghlt{get_constant}@*)(metaobject auto mo)
  -> const auto
  requires(reflects_constant(mo));
  \end{lstlisting}
  \vfill
  \begin{lstlisting}[language=c++2x,basicstyle=\small\ttfamily]
auto (*@\listinghlt{get_value}@*)(metaobject auto mo)
  -> const auto&
  requires(reflects_variable(mo));
  \end{lstlisting}
  \vfill
  \begin{lstlisting}[language=c++2x,basicstyle=\small\ttfamily]
auto (*@\listinghlt{get_value}@*)(metaobject auto mo, auto& obj)
  -> const auto&
...
\begin{frame}[fragile]
  ...
  \begin{lstlisting}[language=c++2x,basicstyle=\footnotesize\ttfamily]
auto (*@\listinghlt{get_reference}@*)(metaobject auto mo)
  -> auto&
  requires(reflects_variable(mo));
  \end{lstlisting}
  \vfill
  \begin{lstlisting}[language=c++2x,basicstyle=\footnotesize\ttfamily]
auto (*@\listinghlt{get_reference}@*)(metaobject auto mo, auto& obj)
  -> auto&
  requires(reflects_record_member(mo) &&
           reflects_variable(mo));
  \end{lstlisting}
  \vfill
  \begin{lstlisting}[language=c++2x,basicstyle=\footnotesize\ttfamily]
auto (*@\listinghlt{get_pointer}@*)(metaobject auto mo)
  -> auto*
  requires(reflects_variable(mo) ||
  ...
  \vfill
  \begin{lstlisting}[language=c++2x,basicstyle=\footnotesize\ttfamily]
auto (*@\listinghlt{get_pointer}@*)(metaobject auto mo, auto& obj)
  -> auto*
  requires(reflects_record_member(mo) &&
           reflects_variable(mo));
  \end{lstlisting}
...
\begin{frame}[fragile]
  ...
  \begin{lstlisting}[language=c++2x,basicstyle=\footnotesize\ttfamily]
auto (*@\listinghlt{apply}@*)(metaobject auto mo, auto&& args_tuple)
  requires(reflects_member_function(mo) &&
           is_static(mo));
  \end{lstlisting}
  \vfill
  \begin{lstlisting}[language=c++2x,basicstyle=\footnotesize\ttfamily]
auto (*@\listinghlt{apply}@*)(auto mo, auto& inst, auto&& args_tuple)
  requires(reflects_member_function(mo) &&
           !is_static(mo));
  \end{lstlisting}
  \vfill
...
auto (*@\listinghlt{apply}@*)(metaobject auto mo, auto&& args_tuple)
  ...
  \vfill
  \begin{lstlisting}[language=c++2x,basicstyle=\footnotesize\ttfamily]
auto (*@\listinghlt{apply_on}@*)(auto mo, auto& inst, auto&& args_tuple)
  requires(reflects_member_function(mo));
  \end{lstlisting}
\end{frame}
% ------------------------------------------------------------------------------
...
using (*@\listinghlt{get_reflected_type_t}@*) = (*@\listinghl{unspecified}@*);
  \end{lstlisting}
  \vfill
  \begin{lstlisting}[language=c++2x,basicstyle=\small\ttfamily]
...
\begin{frame}[fragile]
  ...
  \begin{lstlisting}[language=c++2x,basicstyle=\small\ttfamily]
auto (*@\listinghlt{is_object_sequence}@*)(auto mo) -> bool;
  \end{lstlisting}
  \vfill
  Is there anything in the sequence?
  \begin{lstlisting}[language=c++2x,basicstyle=\footnotesize\ttfamily]
auto (*@\listinghlt{is_empty}@*)(auto mo) -> bool
  requires(is_object_sequence(mo));
  \end{lstlisting}
  \vfill
  How many elements are there?
  \begin{lstlisting}[language=c++2x,basicstyle=\footnotesize\ttfamily]
auto (*@\listinghlt{get_size}@*)(auto mo) -> size_t
  requires(is_object_sequence(mo));
  \end{lstlisting}
  \vfill
  ...
  \begin{lstlisting}[language=c++2x,basicstyle=\footnotesize\ttfamily]
template <size_t I>
auto (*@\listinghlt{get_element}@*)(auto mo)
  requires(is_object_sequence}@*)(mo));
  \end{lstlisting}
  \vfill
  Concatenate
  \begin{lstlisting}[language=c++2x,basicstyle=\footnotesize\ttfamily]
auto (*@\listinghlt{concat}@*)(auto... mo)
  requires((... && is_object_sequence(mo)));
  \end{lstlisting}
\end{frame}
% ------------------------------------------------------------------------------
\begin{frame}[fragile]
  ...
  \begin{lstlisting}[language=c++2x,basicstyle=\small\ttfamily]
void (*@\listinghl{for_each}@*)(auto mo, auto function)
  requires(is_object_sequence(mo));
  \end{lstlisting}
  \begin{lstlisting}[language=c++2x]
(*@\listinghl{for_each}@*)(
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item \inlinecode{fold}, \inlinecode{join}
      \item \inlinecode{flatten},
      \item \inlinecode{is_sorted}, \inlinecode{sort_by}, \inlinecode{group_by}, 
    ...
    \begin{itemize}
      \item \inlinecode{transform}, \inlinecode{filter}
      \item \ldots
    \end{itemize}
  \end{itemize}
\end{frame}
...
const auto has_overloaded_functions =
  (*@\listinghl{any_of}@*)(
    ...
    (*@\listinghl{has_multiple_elements}@*)(_1));
  \end{lstlisting}
\end{frame}
% ------------------------------------------------------------------------------
\begin{frame}[fragile]
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item {\em The Mirror library reference} --
