...
const auto (*@\listinghl{show}@*) = [&](const auto& response) {
  if(response) {
      cout << server.(*@\listinghlt{domain}@*)() << ": " << *response << endl;
  }
};
  \end{lstlisting}
\end{frame}
...
if(sid) {
  show((*@\listinghls{get}@*)(
    {"https://home/(*@\listinghlt{add_user}@*)?username=johnny+password=qwerty+sid=" + *sid}));
  show((*@\listinghls{get}@*)({"https://home/(*@\listinghlt{logout}@*)?sid=" + *sid}));

  sid = (*@\listinghls{get}@*)({"https://johnny:qwerty@home/(*@\listinghlt{login}@*)"});
  show((*@\listinghls{get}@*)({"http://home/(*@\listinghlt{shutdown}@*)?sid=" + *sid}));
  show((*@\listinghls{get}@*)({"https://home/(*@\listinghlt{shutdown}@*)?sid=" + *sid}));
  show((*@\listinghls{get}@*)({"https://home/(*@\listinghlt{open_windows}@*)?room_name=kitchen+sid=" + *sid}));
  show((*@\listinghls{get}@*)({"https://home/(*@\listinghlt{window_status}@*)?room_name=bathroom+sid=" + *sid}));
  show((*@\listinghls{get}@*)({"https://home/(*@\listinghlt{windows_status}@*)?room_name=bathroom+sid=" + *sid}));
  show((*@\listinghls{get}@*)({"https://home/(*@\listinghlt{close_windows}@*)?room_name=study+sid=" + *sid}));
  show((*@\listinghls{get}@*)({"https://home/(*@\listinghlt{logout}@*)?sid=" + *sid}));
  show((*@\listinghls{get}@*)({"https://home/(*@\listinghlt{open_windows}@*)?room_name=bedroom+sid=" + *sid}));

  sid = (*@\listinghls{get}@*)({"https://admin:supersecret@home/(*@\listinghlt{login}@*)"});
  show((*@\listinghls{get}@*)({"https://home/(*@\listinghlt{shutdown}@*)?sid=" + *sid}));
  show((*@\listinghls{get}@*)({"https://home/(*@\listinghlt{logout}@*)?sid=" + *sid}));
}
  \end{lstlisting}
