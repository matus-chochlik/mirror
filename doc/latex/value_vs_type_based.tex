...
consteval void my_reusable_algo(
  ...
  \end{lstlisting}
  making everything a template. But then this becomes slower to compile, defeating
  one of the main points of this API.
\end{frame}
% ------------------------------------------------------------------------------
\begin{frame}
...
concept (*@\listinghlt{metaobject}@*) = (*@\listinghlt{unspecified}@*);
